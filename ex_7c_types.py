...
##Note (click)
##The parentheses are optional; the author believes they improve readability. In other words, is the same as .
...
##Python calls them 'bool', which is short for 'boolean'. As you'll find documented on thousands of websites, a boolean value is simply a value that can only be True or False.
