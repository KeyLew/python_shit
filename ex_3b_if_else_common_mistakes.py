...
# ## 4
# ## What's wrong with this code? no variable. no variable 
# input("What is your name? ")
# if "Bob":
#     print("Hello Robert.")
    
# ## 5
# ## What's wrong with this code? no variable in if statement.
# name = input("What is your name? ")
# if "Bob":
#     print("Hello Robert.")

# ## 6
# ## What's wrong with this code? no variable on input statement.
# input("What is your name? ")
# if input == "Bob":
#     print("Hello Robert.")

# ## 7 
## What's wrong with this code? name=none
# name = print(input("What is your name? "))
# if name == "Bob":
#     print("Hello Robert.")
    
# ## 8
# ## What's wrong with this code?dont need print after input
...
# ## 9
# ## What's wrong with this code? if statements arent clarified
