...
# diff = num / num2
# rem = num % num2
# print(f"if you divided {num} by {num2}, then you would get {diff} with a remainder of {rem}")

## 3
# num = int(input("type a number: "))
# num2 = int(input("type a different number: "))
# expo = num ** num2
# print(f"If you computed {num} to the power of {num2}, then you would get {expo}.")

## 4
## Based on question #1, does % calculate a percentage? No
## Based on question #2, does ^ calculate an exponent? No
